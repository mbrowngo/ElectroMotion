...
$query_getContentMobile = "SELECT * FROM EMContent WHERE contentID = 48 AND contentActive = 1";
...
mysql_select_db($database_php, $php);
$query_getContentMain = "SELECT * FROM EMContent WHERE contentID = 49 AND contentActive = 1";
...
if (!isset($_SESSION["landingPage"]))     {
  $_SESSION["landingPage"] = "mainmotorgen";
}
?>
...
<title>Frequency Converters | Electro-Motion Inc.</title>
<meta name="description" content="Frequency converter supplier and maintenance for Horlick, Kato, IPS, CPP, Georator and
others in the San Francisco Bay Area, including San Francisco County, San Mateo County, Santa Clara County, Santa Cruz County, Contra Costa County,
Alameda County, Marin County, Bay Area, Silicon Valley, Peninsula, Alviso, Aptos, Atherton, Belmont, Brisbane, Broadmoor, Burlingame, Campbell, Capitola, Castro Valley, Colma, Cupertino, Daly City, Dublin, East Palo Alto, El Granada, Oakland, Berkeley, Foster City, Fremont, Gilroy, Half Moon Bay,
Hayward, Hillsborough, La Honda, Livermore, Los Altos, Los Altos Hills, Los Gatos, Menlo Park, Millbrae, Milpitas, Montara, Monte Sereno, Morgan Hill,
