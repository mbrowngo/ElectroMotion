...
$query_getContentMain = "SELECT * FROM EMContent WHERE contentID = 73 AND contentActive = 1";
...
<title>About Us | Electro-Motion&rsquo;s History | Electro-Motion Inc.</title>

<meta name="description" content=&quot;Electro-Motion has provided power generator service and generator 
repair to the San Francisco Bay Area and Silicon Valley since 1967."> 
...
mysql_free_result($getContentsMain);
?>
