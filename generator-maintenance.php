...
$query_getContentMobile = "SELECT * FROM EMContent WHERE contentID = 60 AND contentActive = 1";
...
mysql_select_db($database_php, $php);
$query_getContentMain = "SELECT * FROM EMContent WHERE contentID = 61 AND contentActive = 1";
