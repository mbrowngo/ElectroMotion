...
<section id="home" data-role="page">
	<div class="content" data-role="content">
		<div class="mainContent">
			<img src="graphics/homemobile.jpg" style="margin-left:-15px;margin-top:-15px;"/>
		</div>
	</div>
</section>
		...
		<div class="mainContent">
			...
			<div>
				<p>To request more information, please fill out our form below. 
				    ...
				    <form id="form1" name="form1" method="POST" action="infoformcomponentMOBILE.php" class="formformat">
